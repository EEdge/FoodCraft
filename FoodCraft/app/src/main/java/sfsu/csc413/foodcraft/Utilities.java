...
public class Utilities {
    ...
    /** Private constructor - don't touch - class exists solely for static methods */
    private Utilities() {}
    ...
    /**
     * Given an ingredient, will perform several rounds of cleaning and parsing to better match the
     * app's ingredient formatting standards.
     *
     * @param ingredient An ingredient.
